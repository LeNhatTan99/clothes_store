    ...
    @include('admin.breadcrumbs',
            [
                'breadcrumb'=> [
                    ...
                    ['title' => 'Quản lý sản phẩm', 'url' =>route('products.index') ],
                    ['title' => 'Chỉnh sửa sản phẩm', 'url' =>"#" ],
                ]
            ])
@stop
@section('content')
            ...
            <div class=" py-2 px-3">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea  type="text" class=" form-control create-textarea" name="description"  cols="30" rows="20">{{old('description',$product->description)}}</textarea>
